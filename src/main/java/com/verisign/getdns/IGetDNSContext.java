...
public interface IGetDNSContext {
	...
	GetDNSFutureResult addressAsync(String name,
			HashMap<String, Object> extensions) throws GetDNSException;
	
	GetDNSFutureResult serviceAsync(String name,
			HashMap<String, Object> extensions) throws GetDNSException;
	
	GetDNSFutureResult hostnameAsync(String address, HashMap<String, Object> extensions)
			throws GetDNSException, UnknownHostException ;
